    ...
    class AUX_95th_Unit_Unarmoured_##PLAYER_NAME : FIG_CadianUniformV1_inf_B {\
        scope = 2;
        scopecurator=2;
        faction=QUOTE(AUX_95th_Legion_Faction_Imperial_Guard);
    ...
    class AUX_95th_Unit_Light_##PLAYER_NAME : FIG_CadianUniformV2_inf_B {\
        scope = 2;
        scopecurator=2;
        faction=QUOTE(AUX_95th_Legion_Faction_Imperial_Guard);
        editorSubcategory=QUOTE(DOUBLES(AUX_95th_Legion_Characters_Category_Squad,SQUAD_KEY));
    ...
    class AUX_95th_Unit_Medium_##PLAYER_NAME : FIG_CadianUniformV3_inf_B {\
        scope = 2;
        scopecurator=2;
        faction=QUOTE(AUX_95th_Legion_Faction_Imperial_Guard);
        editorSubcategory=QUOTE(DOUBLES(AUX_95th_Legion_Characters_Category_Squad,SQUAD_KEY));
    ...
    class AUX_95th_Unit_Heavy_##PLAYER_NAME : FIG_CadianUniformV4_inf_B {\
        scope = 2;
        scopecurator=2;
        faction=QUOTE(AUX_95th_Legion_Faction_Imperial_Guard);
        editorSubcategory=QUOTE(DOUBLES(AUX_95th_Legion_Characters_Category_Squad,SQUAD_KEY));
