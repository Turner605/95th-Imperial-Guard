...
class JLTS_Clone_P2_DC15A: B_Soldier_f {};
    ...
    class AUX_95th_Unit_P1_MC_##PLAYER_NAME : JLTS_Clone_P2_DC15A {\
        ...
        respawnLinkedItems[]={QUOTE(DOUBLES(AUX_95th_Helmet_P1_Basic,PLAYER_NAME)),"95th_Basic_Vest_Trooper","ItemMap","JLTS_clone_comlink","ItemCompass","ItemWatch"};
        hiddenSelectionsTextures[]={
            QUOTE(\z\AUX_95th_40k_IG_Main\addons\players\PLAYER_NAME\data\uniforms\p1_mc\Uniform_Upper.paa), 
            QUOTE(\z\AUX_95th_40k_IG_Main\addons\players\PLAYER_NAME\data\uniforms\p1_mc\Uniform_Lower.paa)
        };
    };
#endif
    ...
    class AUX_95th_Unit_P1_Cold_Assault_##PLAYER_NAME : 3AS_Rep_ColdAssault_base_F {\
        ...
        hiddenSelectionsTextures[]={
            QUOTE(\z\AUX_95th_40k_IG_Main\addons\players\PLAYER_NAME\data\uniforms\p1_coldAssault\Uniform.paa), 
            QUOTE(\z\AUX_95th_40k_IG_Main\addons\players\PLAYER_NAME\data\uniforms\p1_coldAssault\Uniform.paa)
        };
    };
#endif
    ...
    class AUX_95th_Unit_Commando_##PLAYER_NAME : 3AS_Rep_Commando_F {\
        ...
        hiddenSelectionsTextures[]={
            QUOTE(\z\AUX_95th_40k_IG_Main\addons\players\PLAYER_NAME\data\uniforms\p1_commando\Uniform.paa), 
