#define NEW_95TH_ANTENNA(COLOUR) class AUX_95th_P1_Facewear_Antenna_##COLOUR : AUX_95th_Facewear_Base {\
    ...
    hiddenSelectionsTextures[]={QUOTE(\z\AUX_95th_40k_IG_Main\addons\players\shared\data\facewear\Antenna\COLOUR.paa)};\
    class XtdGearInfo {\
...
#define NEW_95TH_HEADLAMP(COLOUR) class AUX_95th_P1_Facewear_Headlamp_##COLOUR : AUX_95th_Facewear_Base {\
    ...
    hiddenSelectionsTextures[]={QUOTE(\z\AUX_95th_40k_IG_Main\addons\players\shared\data\facewear\Headlamp\COLOUR.paa)};\
    class XtdGearInfo {\
        model = QUOTE(AUX_95th_Facewear_P1);\
        Type = QUOTE(Headlamp);\
        Colour = QUOTE(COLOUR);\
...
#define NEW_95TH_HEADLAMPS(COLOUR) class AUX_95th_P1_Facewear_Headlamps_##COLOUR : AUX_95th_Facewear_Base {\
    ...
    hiddenSelectionsTextures[]={QUOTE(\z\AUX_95th_40k_IG_Main\addons\players\shared\data\facewear\Headlamps\COLOUR.paa)};\
    class XtdGearInfo {\
        model = QUOTE(AUX_95th_Facewear_P1);\
...
#define NEW_95TH_SCARF(COLOUR) class AUX_95th_Facewear_Scarf_##COLOUR : SWLB_CEE_Clone_Scarf {\
	...
	scope=2;\
    hiddenSelectionsTextures[]={QUOTE(\z\AUX_95th_40k_IG_Main\addons\players\shared\data\facewear\Scarf\COLOUR.paa)};\
    class XtdGearInfo {\
...
#define NEW_95TH_PONCHO(COLOUR) class AUX_95th_Facewear_Poncho_##COLOUR : PhoenixCore_Poncho {\
	...
	author = QUOTE(95th Aux Team);\
	scope=2;\
    hiddenSelectionsTextures[]={QUOTE(\z\AUX_95th_40k_IG_Main\addons\players\shared\data\facewear\Poncho\COLOUR.paa)};\
    class XtdGearInfo {\
